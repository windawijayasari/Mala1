...
#' Title Transition matrices from each year
#'
#' @param reclassified_table a csv file from the MODIS data extraction
#' @param year_from year start
#' @param year_to year end
#'
#' @description
...
#' all_lc_matrices = lapply(years, function(year){Get_matrix_by_year(reclassified_table, year)})
